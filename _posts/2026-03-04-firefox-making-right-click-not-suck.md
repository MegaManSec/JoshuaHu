...
| <img src="/files/holyshit-firefox.png" alt="Firefox fresh-install right-click" width="400"> |
|:--:|
| *Freshly installed Firefox, right-clicking* |

To be blunt: holy fucking shit, what the fuck is all of this shit? 26 rows of which 2 are greyed-out (aka: fucking useless), 8 dividers, 2 submenus; because a single row for "Ask an AI Chatbot" just wasn't enough, they just had to make another _submenu_. Amazing.
...
* `print.enabled` -- Completely disables Firefox' printing UI and capabilities, which also removes the "Print" and "Print Selection..." buttons. Don't want to remove this functionality? See [my next post](https://joshua.hu/firefox-making-right-click-not-suck-even-more-with-userchrome).

How do we look now?

| <img src="/files/firefox-fail.png" alt="Firefox right-click after disabling the above options" width="400"> |
|:--:|
...
| <img src="/files/firefox-click-notext.png" alt="Right-clicking on a page" width="250"> | <img src="/files/firefox-click-link.png" alt="Right-clicking on a link" width="250"> |
| :--: | :--: |
...
Those remaining useless buttons can only be removed by creating a custom [userChrome.css](https://www.userchrome.org/what-is-userchrome-css.html). I'll cover how to do that in [my next post](https://joshua.hu/firefox-making-right-click-not-suck-even-more-with-userchrome).
