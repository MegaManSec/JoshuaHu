---
layout: post
title: "Getting root with a single command on Ubuntu: sudo /usr/sbin/logrotate"
author: "Joshua Rogers"
categories: security
---

The scenario is this: a brand new Ubuntu 22.04 server has a shell account which is restricted to running `sudo logrotate *`.  Can we get root? Short answer: Yes. I couldn't find much online about this type of exploitation of logrotate, so let's document something for future use.
